...
import cn.gemrun.base.module.pay.enums.DictTypeConstants;
...
import cn.gemrun.base.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
...
import cn.gemrun.base.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.gemrun.base.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.gemrun.base.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.gemrun.base.module.trade.controller.admin.order.vo.*;
import cn.gemrun.base.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.gemrun.base.module.trade.controller.app.order.vo.*;
import cn.gemrun.base.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.gemrun.base.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.gemrun.base.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.gemrun.base.module.trade.framework.order.config.TradeOrderProperties;
import cn.gemrun.base.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/basecode/base-mall-uniapp/issues/ICY7SJ
