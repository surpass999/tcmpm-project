package cn.gemrun.base.module.iot.gateway.config;

import cn.gemrun.base.module.iot.core.messagebus.core.IotMessageBus;
import cn.gemrun.base.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import cn.gemrun.base.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import cn.gemrun.base.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import cn.gemrun.base.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import cn.gemrun.base.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import cn.gemrun.base.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import cn.gemrun.base.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import cn.gemrun.base.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import cn.gemrun.base.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import cn.gemrun.base.module.iot.gateway.protocol.mqttws.IotMqttWsDownstreamSubscriber;
import cn.gemrun.base.module.iot.gateway.protocol.mqttws.IotMqttWsUpstreamProtocol;
import cn.gemrun.base.module.iot.gateway.protocol.mqttws.manager.IotMqttWsConnectionManager;
import cn.gemrun.base.module.iot.gateway.protocol.mqttws.router.IotMqttWsDownstreamHandler;
import cn.gemrun.base.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import cn.gemrun.base.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import cn.gemrun.base.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import cn.gemrun.base.module.iot.gateway.service.device.IotDeviceService;
import cn.gemrun.base.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "base.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "base.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "base.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "base.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "base.iot.gateway.protocol.mqtt-ws", name = "enabled", havingValue = "true")
    @Slf4j
