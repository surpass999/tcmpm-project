package cn.gemrun.base.module.iot.job.device;
...
import cn.gemrun.base.module.iot.framework.iot.config.BaseIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private BaseIotProperties iotProperties;
