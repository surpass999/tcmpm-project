package cn.gemrun.base.module.iot.core.messagebus.config;

import cn.gemrun.base.framework.mq.redis.core.RedisMQTemplate;
import cn.gemrun.base.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.gemrun.base.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.gemrun.base.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.gemrun.base.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.gemrun.base.module.iot.core.messagebus.core.IotMessageBus;
import cn.gemrun.base.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.gemrun.base.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.gemrun.base.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
import cn.gemrun.base.module.iot.core.mq.producer.IotDeviceMessageProducer;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "base.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "base.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 BaseRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.gemrun.base.framework.mq.redis.config.BaseRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "base.iot.message-bus", name = "type", havingValue = "redis")
