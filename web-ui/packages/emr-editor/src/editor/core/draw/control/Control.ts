...
export class Control {
  ...
  public emitControlChange(state: ControlState) {
    ...
    if (value?.length) {
      const zippedElement = zipElementList(value)[0]
      control = zippedElement?.control!
    } else {
  ...
  public emitControlContentChange(options?: IControlChangeOption) {
    ...
    if (controlValue?.length) {
      const zippedElement = zipElementList(controlValue)[0]
      control = zippedElement?.control!
    } else {
