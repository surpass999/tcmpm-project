      ...
      >
        <div class="p-1">
          ...
          <ElRow class="border border-gray-200 px-4 py-3">
            <ElCol :span="9" class="font-bold">操作按钮</ElCol>
            <ElCol :span="9" class="font-bold">显示名称</ElCol>
          ...
          <div v-for="(item, index) in buttonsSetting" :key="index">
            <ElRow class="border border-t-0 border-gray-200 px-4 py-2">
              <ElCol :span="9" class="flex items-center truncate">
                {{ OPERATION_BUTTON_NAME.get(item.id) }}
              </ElCol>
              <ElCol :span="9" class="flex items-center">
                <ElInput
