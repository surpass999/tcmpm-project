package cn.gemrun.base.module.system.service.user;
...
import cn.gemrun.base.framework.common.util.collection.ArrayUtils;
...
import cn.gemrun.base.module.infra.api.file.FileApi;
import cn.gemrun.base.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.gemrun.base.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.gemrun.base.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.gemrun.base.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.gemrun.base.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.gemrun.base.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import static cn.gemrun.base.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("baseyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("baseyuanma");
        ...
        assertEquals("baseyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("baseyuanma"))).thenReturn("java");
