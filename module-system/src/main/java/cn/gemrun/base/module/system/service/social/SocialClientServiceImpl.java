package cn.gemrun.base.module.system.service.social;
...
import cn.gemrun.base.framework.common.util.cache.CacheUtils;
import cn.gemrun.base.framework.common.util.http.HttpUtils;
import cn.gemrun.base.framework.common.util.object.BeanUtils;
import cn.gemrun.base.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.gemrun.base.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.gemrun.base.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.gemrun.base.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.gemrun.base.module.system.dal.dataobject.social.SocialClientDO;
import cn.gemrun.base.module.system.dal.mysql.social.SocialClientMapper;
import cn.gemrun.base.module.system.dal.redis.RedisKeyConstants;
import cn.gemrun.base.module.system.enums.social.SocialTypeEnum;
import cn.gemrun.base.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.gemrun.base.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.gemrun.base.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${base.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${base.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/base-cloud/pulls/230
