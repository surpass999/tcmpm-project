package cn.gemrun.base.module.system.service.oauth2;
...
import cn.gemrun.base.module.system.dal.dataobject.oauth2.OAuth2RefreshTokenDO;
import cn.gemrun.base.module.system.dal.dataobject.user.AdminUserDO;
import cn.gemrun.base.module.system.dal.mysql.oauth2.OAuth2AccessTokenMapper;
import cn.gemrun.base.module.system.dal.mysql.oauth2.OAuth2RefreshTokenMapper;
import cn.gemrun.base.module.system.dal.redis.oauth2.OAuth2AccessTokenRedisDAO;
...
public class OAuth2TokenServiceImpl implements OAuth2TokenService {
    ...
    /**
     * 加载用户信息，方便 {@link cn.gemrun.base.framework.security.core.LoginUser} 获取到昵称、部门等信息
     *
     * @param userId 用户编号
     * @param userType 用户类型
     * @return 用户信息
    ...
    private Map<String, String> buildUserInfo(Long userId, Integer userType) {
        ...
        if (userType.equals(UserTypeEnum.ADMIN.getValue())) {
            ...
            return MapUtil.builder(LoginUser.INFO_KEY_NICKNAME, user.getNickname())
                    ...
                    .put("passwordMustChange", String.valueOf(Boolean.TRUE.equals(user.getPasswordMustChange()))).build();
