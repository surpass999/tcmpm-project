...
import cn.gemrun.base.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
...
import cn.gemrun.base.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/base-cloud/issues/I8SM9H 场景
