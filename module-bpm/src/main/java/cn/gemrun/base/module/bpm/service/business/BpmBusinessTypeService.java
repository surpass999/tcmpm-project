package cn.gemrun.base.module.bpm.service.business;
...
public interface BpmBusinessTypeService {
    ...
    /**
     * 获取分类下所有已启用的流程定义Key列表
     *
     * @param category 流程分类（如 project, filing）
     * @return 流程定义Key列表
     */
    List<String> getProcessDefinitionKeysByCategory(String category);
