...
@Schema(description = "管理后台 - 批量查询流程任务状态 Response VO")
@Data
public class BpmTaskBatchStatusRespVO {
    ...
    @Schema(description = "待办任务列表（当前用户的）", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private List<TodoTask> todoTasks;

    @Schema(description = "已完成的任务列表（当前用户的）", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private List<DoneTask> doneTasks;

    @Schema(description = "所有已完成的任务列表（用于审批记录展示）", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
