package cn.gemrun.base.module.bpm.controller.admin.definition.vo.model;
...
public class BpmModelRespVO extends BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "process_base")
    private String key;

    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "芋道")
    private String name;

    @Schema(description = "流程图标", example = "https://www.iocoder.cn/base.jpg")
    private String icon;
