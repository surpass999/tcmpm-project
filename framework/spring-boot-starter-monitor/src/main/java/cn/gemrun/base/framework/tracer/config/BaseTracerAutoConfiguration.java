package cn.gemrun.base.framework.tracer.config;

import cn.gemrun.base.framework.common.enums.WebFilterOrderEnum;
import cn.gemrun.base.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "base.tracer", value = "enable", matchIfMissing = true)
public class BaseTracerAutoConfiguration {
