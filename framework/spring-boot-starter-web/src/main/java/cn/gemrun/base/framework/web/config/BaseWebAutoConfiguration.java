package cn.gemrun.base.framework.web.config;
...
import cn.gemrun.base.framework.web.core.filter.CacheRequestBodyFilter;
import cn.gemrun.base.framework.web.core.filter.DemoFilter;
import cn.gemrun.base.framework.web.core.handler.GlobalExceptionHandler;
import cn.gemrun.base.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class BaseWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "base.demo", havingValue = "true")
