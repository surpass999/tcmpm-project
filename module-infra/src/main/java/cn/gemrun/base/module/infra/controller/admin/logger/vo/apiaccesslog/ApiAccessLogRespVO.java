package cn.gemrun.base.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.gemrun.base.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
