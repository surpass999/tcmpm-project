package cn.gemrun.base.module.infra.service.logger;
...
import cn.gemrun.base.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.gemrun.base.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.gemrun.base.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.gemrun.base.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.gemrun.base.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.gemrun.base.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("base-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("base-test");
