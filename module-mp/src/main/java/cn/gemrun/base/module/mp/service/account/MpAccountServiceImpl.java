package cn.gemrun.base.module.mp.service.account;
...
import cn.gemrun.base.module.mp.convert.account.MpAccountConvert;
import cn.gemrun.base.module.mp.dal.dataobject.account.MpAccountDO;
import cn.gemrun.base.module.mp.dal.mysql.account.MpAccountMapper;
import cn.gemrun.base.module.mp.enums.ErrorCodeConstants;
...
import static cn.gemrun.base.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        // 注意：忽略自动多租户，因为要全局初始化缓存
            ...
            try {
                ...
                log.error("[微信公众号 base-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
