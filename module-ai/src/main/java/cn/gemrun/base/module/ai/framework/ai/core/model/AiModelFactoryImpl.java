package cn.gemrun.base.module.ai.framework.ai.core.model;
...
import cn.gemrun.base.framework.common.util.spring.SpringUtils;
import cn.gemrun.base.module.ai.enums.model.AiPlatformEnum;
import cn.gemrun.base.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.gemrun.base.module.ai.framework.ai.config.BaseAiProperties;
...
import cn.gemrun.base.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.gemrun.base.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            BaseAiProperties.Midjourney properties = SpringUtil.getBean(BaseAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(BaseAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        BaseAiProperties.DouBao properties = new BaseAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(BaseAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        BaseAiProperties.HunYuan properties = new BaseAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(BaseAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        BaseAiProperties.SiliconFlow properties = new BaseAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(BaseAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        BaseAiProperties.XingHuo properties = new BaseAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(BaseAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        BaseAiProperties.BaiChuan properties = new BaseAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(BaseAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        BaseAiProperties.Gemini properties = SpringUtil.getBean(BaseAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        BaseAiProperties.Grok properties = new BaseAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
